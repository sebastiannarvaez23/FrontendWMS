...
export const ContainBoxItem = (props) => {
    ...
    return (
        <div className="ref-admin">
            ...
            <button onClick={() => { createBoxItem(setListBoxItems, setLoadGetBoxItems, setQuantity, setInpReference, defaultDataBoxItem) }} className="btn-pack" disabled={!inpReference}>Empacar</button>
